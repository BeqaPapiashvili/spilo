      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-12 border-b border-gray-800">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-lg text-white">ოფიციალური გარანტია</h4>
              <p className="text-sm text-gray-400">ყველა პროდუქტზე</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-lg text-white">0%-იანი განვადება</h4>
              <p className="text-sm text-gray-400">TBC და BOG ბანკებით</p>
            </div>
          </div>
        </div>
