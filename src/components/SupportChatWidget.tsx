...
export default function SupportChatWidget() {
  ...
  return (
    <>
      ...
      {/* Bottom-Right Floating Action Island */}
      <div className="fixed bottom-20 md:bottom-6 right-4 md:right-6 z-50 flex flex-col items-end gap-2.5 select-none">

        {/* 1. Floating Compare Button (White Icon with Brand Coral Badge) */}
        <Link
          href="/compare"
        ...
        {/* 2. Chat Window (Bright Coral + High-End Glassmorphism Design) */}
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="w-[340px] sm:w-[380px] h-[520px] rounded-[36px] p-2.5 sm:p-3 flex flex-col justify-between relative shadow-[0_25px_70px_-15px_rgba(0,0,0,0.25)] border border-white/80 overflow-hidden"
              style={{
                background: "linear-gradient(145deg, rgba(255,255,255,0.98) 0%, rgba(255,245,242,0.95) 100%)",
            ...
            >
              ...
              <div className="flex-1 bg-white rounded-[28px] border border-zinc-100/90 shadow-2xs relative overflow-hidden flex flex-col">
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between relative">
                    ...
                    <div>
                      <div className="mt-4 mb-5">
                        ...
                        <p className="text-xs text-zinc-500 mt-1">შეიყვანეთ სახელი და ნომერი დასაკავშირებლად</p>
                      </div>
                ...
                {/* STEP 3: ACTIVE CONVERSATION (მხარდაჭერა & ჩატი) */}
                {chatStep === "chat" && (
                  <div className="flex-1 flex flex-col h-full overflow-hidden">
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="p-3 border-b border-zinc-100 flex items-center justify-between bg-zinc-50/60">
                    ...
                    <div
                      ...
                      className="flex-1 overflow-y-auto p-4 space-y-3 bg-zinc-50/40"
                    >
                      {messages.map((msg) => {
                              ...
                              {msg.attachment && (
                                <div className="mt-2 pt-2 border-t border-black/10">
                                  {msg.attachment.type === "image" ? (
                                    <a href={msg.attachment.url} target="_blank" rel="noreferrer" className="block overflow-hidden rounded-xl">
                                      <img src={msg.attachment.url} alt={msg.attachment.name} className="max-h-40 w-full object-cover rounded-xl" />
                                    </a>
                                  ) : (
                                    <a
                    ...
                    {/* Quick Reply Chips */}
                    <div className="px-3 py-1.5 bg-white border-t border-zinc-100 flex items-center gap-1.5 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                      {[
                        "როდის ჩამაბარებენ?",
                    ...
                    {/* Input Bar */}
                    <div className="p-2.5 bg-white border-t border-zinc-100 relative">
                      ...
                      >
                        <button
                          ...
                          className="p-2 text-zinc-400 hover:text-[#FF5238] rounded-full hover:bg-zinc-100 transition-colors cursor-pointer"
